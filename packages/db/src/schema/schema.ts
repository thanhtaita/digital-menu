...
export const ingredients = pgTable(
  "ingredients",
  {
     ...
     */
    dietTags: jsonb("diet_tags").$type<Record<string, boolean>>(),
 ...
 */
export const ingredientDietCandidates = pgTable(
  "ingredient_diet_candidates",
  {
    id: serial("id").primaryKey(),
    ingredientId: integer("ingredient_id")
      .notNull()
  ...
  (table) => ({
    ingredientDietTypeUnique: uniqueIndex("ingredient_diet_candidates_ingredient_id_diet_type_unique").on(
      table.ingredientId,
      table.dietType
    ),
 ...
 */
export const aiContentTranslations = pgTable(
  ...
  (table) => ({
    entityFieldLocaleUnique: uniqueIndex("ai_content_translations_entity_field_locale_unique").on(
      table.entityType,
      table.entityId,
      table.field,
      table.locale
...
export type NewAiContentTranslation = typeof aiContentTranslations.$inferInsert;
...
export const dishEmbeddings = pgTable(
  "dish_embeddings",
  {
    id: serial("id").primaryKey(),
...
export type NewIngredientDietCandidate = typeof ingredientDietCandidates.$inferInsert;
